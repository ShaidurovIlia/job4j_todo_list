...
public class ItemRepositoryTest {
    ...
    @Test
    public void create() {
        User newUser = new User(0, "name", "20@2", "1");
        user.create(newUser);
...
//                new Item(
//                item.getId(), newUser, "test", "test", LocalDateTime.now(), false),
//                new Item(
//                itemFirst.getId(), newUser, "test1", "test1", LocalDateTime.now(), false),
//                new Item(
//                itemSecond.getId(), newUser, "test2", "test2", LocalDateTime.now(), false));
